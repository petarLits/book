...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  ...
  Future<void> _onSaveNewBook(SaveNewBook event, Emitter<HomeState> emit)async {
    emit(SaveBookState(book: event.book));
  }

  Future<void> _onAddBookImage(AddBookImage event, Emitter<HomeState> emit) async{
    emit(AddBookImageState(image: event.image));
  }

  Future<void> _onUploadBookImage(UploadBookImageAndGetUrl event, Emitter<HomeState> emit) async{
  ...
  Future<void> _onDeleteBookImage(DeleteBookImage event, Emitter<HomeState> emit) async {
